...
---
## 🏗️ **Estrucutra del Folder**

📦 Eco-Flow-2026
├── 📄 Makefile                 # Configuración de compilación
├── 📄 README.md                # Este archivo
├── 📄 main.c                    # Punto de entrada
├── 📄 structuras.h              # Definiciones de estructuras
├── 📄 structuras.c              # Inicialización de estructuras
├── 📄 procesos_hilos.h          # Implementación de hilos
├── 📄 user_process.h            # Prototipos de funciones usuario
├── 📄 user_process.c            # Acciones de usuario
├── 📄 utilidades.h              # Prototipos de utilidades
├── 📄 utilidades.c              # Funciones auxiliares
├── 📄 iniciar_sistema.h         # Inicialización del sistema
...
Gabriel Silva	-	Desarrollo de hilos y sincronización
Gabriel Pinto	-	Desarrollo de procesos de usuario
Dervis Martinez 	Desarrollo de estructuras e inicialización
Isaac Baron 	-	Pruebas y documentación
